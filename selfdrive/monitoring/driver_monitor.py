...
_AWARENESS_PRE_TIME_TILL_TERMINAL = 25.  # a first alert is issued 15s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 15.  # a second alert is issued 6s before start decelerating the car
_DISTRACTED_TIME = 15.
